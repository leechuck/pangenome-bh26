...
def main():
    ...
    lines += ['## Post-freeze probe-coverage audit','', 'All 91 validation C4 genes contain all 15 A/B diagnostic probes for their assembly-assigned class. All 60 long genes contain 16 probes at each insertion junction; all 31 short genes contain 16 deletion-junction probes. Thus no assembled diagnostic window is absent from the frozen vocabulary in this set.', '', 'HG04204 has 39 A-supporting and 19 B-supporting fragments despite complete probe coverage of both A and both B genes. Probe dropout does not explain this discrepancy. Stochastic sampling or upstream mapping/recruitment effects remain possible; this audit does not establish their cause. See `results/validation_probe_coverage.tsv`.', '']
