...
**Execution update:** Robert explicitly authorised execution. [The initial mixed-cohort run](run/README.md) has completed call generation and output verification on DDBJ (20 East Asian + 20 South Asian; Arabian validation deferred by Robert). The feasibility status and decision below are historical.
